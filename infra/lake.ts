...
const tableBucketName = `smart-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `smart-${$app.stage}-lake-ingest`,
    destination: "iceberg",
