...
declare const SMART_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof SMART_LIBC === "undefined" ? undefined : SMART_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@smartcode/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.SMART_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.SMART_EXPERIMENTAL_FILEWATCHER) {
