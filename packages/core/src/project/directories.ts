...
import type { EffectDrizzleSqlite } from "@smartcode-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@smartcode/ProjectDirectories") {}
