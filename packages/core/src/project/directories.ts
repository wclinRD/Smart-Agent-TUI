...
import type { EffectDrizzleSqlite } from "@smart-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@smart/ProjectDirectories") {}
