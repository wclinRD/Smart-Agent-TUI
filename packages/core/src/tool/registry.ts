...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@smartcode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@smartcode/v2/ToolRegistry") {}
