...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@smart-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@smart/v2/ToolRegistry") {}
