...
const statsHomeTitle = "Smart Data"
const statsHomeDescription = "Smart usage data, market share, token cost, and session cost."
const statsHomeFallbackUrl = "https://smart.ai/data/"
...
function getStatsHomeUrl(base: string, requestUrl: string) {
  ...
  if (url.hostname === "stats.smart.ai") return "https://smart.ai/data/"
  if (url.hostname === "stats.dev.smart.ai") return "https://dev.smart.ai/data/"
  return url.toString()
}
  ...
  return (
    <section id="top-models" data-section="top-models">
      <h2 data-slot="top-models-title">
        <strong>Top models.</strong> <span>Usage of models across Smart Go.</span>
      </h2>
      <Show
