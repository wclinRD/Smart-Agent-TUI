...
Practical reference for the current tool-migration state in `packages/smart`.
...
Tool tests should use the existing Effect helpers in `packages/smart/test/lib/effect.ts`:
