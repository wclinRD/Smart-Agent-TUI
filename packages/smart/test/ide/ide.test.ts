...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders SMART_CALLER", () => {
    process.env["SMART_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode SMART_CALLER", () => {
    process.env["SMART_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown SMART_CALLER", () => {
    process.env["SMART_CALLER"] = "unknown"
