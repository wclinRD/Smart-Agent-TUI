...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips smart-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-smart-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-smart-directory")).toBeNull()
      expect(result.get("x-smart-workspace")).toBeNull()
