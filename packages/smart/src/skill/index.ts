...
import { FrontmatterError } from "@smart-ai/core/v1/config/error"
import { ConfigMarkdown } from "@/config/markdown"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Glob } from "@smart-ai/core/util/glob"
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, SMART_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@smart/Skill") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_SMART_SKILL_NAME] = {
          name: CUSTOMIZE_SMART_SKILL_NAME,
          description: CUSTOMIZE_SMART_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_SMART_SKILL_BODY,
        }
