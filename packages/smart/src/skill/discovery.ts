...
import { httpClient, path } from "@smart-ai/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@smart/SkillDiscovery") {}
