...
import type * as SDK from "@smart-ai/sdk/v2"
...
import { SessionShareTable } from "@smart-ai/core/share/sql"
...
const disabled = process.env["SMART_DISABLE_SHARE"] === "true" || process.env["SMART_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@smart/ShareNext") {}
