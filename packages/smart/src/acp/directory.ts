...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@smart/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@smart/ACPDirectory") {}
