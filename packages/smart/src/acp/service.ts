...
import type { Message, OpencodeClient, SessionMessageResponse } from "@smart-ai/sdk/v2"
...
export class Service extends Context.Service<Service, Interface>()("@smart/ACP/Service") {}
...
export function make(input: {
  ...
  const initialize = Effect.fn("ACP.initialize")(function* (params: InitializeRequest) {
    ...
    const authMethod: AuthMethod = {
      description: "Run `smart auth login` in the terminal",
