...
export class Service extends Context.Service<Service, Interface>()("@smart/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __SMART_PHOTON_WASM_PATH?: string }).__SMART_PHOTON_WASM_PATH =
