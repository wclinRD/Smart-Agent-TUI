...
import { isRecord } from "@smart-ai/tui/util/record"
...
import { TuiKeybind } from "@smart-ai/tui/config/keybind"
...
export class Service extends Context.Service<Service, Interface>()("@smart/TuiConfig") {}
