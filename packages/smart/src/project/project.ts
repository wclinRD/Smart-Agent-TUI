...
import { ProjectDirectoryTable, ProjectTable } from "@smart-ai/core/project/sql"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@smart-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@smart/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.SMART_FAKE_VCS)
