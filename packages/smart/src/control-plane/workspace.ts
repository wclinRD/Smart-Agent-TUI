...
import { EventSequenceTable, EventTable } from "@smart-ai/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@smart/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        SMART_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        SMART_WORKSPACE_ID: config.id,
        SMART_EXPERIMENTAL_WORKSPACES: "true",
