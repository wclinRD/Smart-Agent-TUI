...
import type { Event, GlobalEvent, OpencodeClient } from "@smart-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@smart/RunStreamTransport") {}
