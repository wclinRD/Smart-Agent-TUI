import type { PermissionV1 } from "@smart-ai/core/v1/permission"
// CLI entry point for `smart run`.
//
// Handles three modes:
...
import { createOpencodeClient, type OpencodeClient, type ToolPart } from "@smart-ai/sdk/v2"
