import type { JsonSchema, LLMRequest, ProviderMetadata } from "@smart-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@smart-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @smart-ai/llm request objects from smart's session/AI SDK-shaped data.
  return LLM.request({
