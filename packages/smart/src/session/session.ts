...
import { PartTable, SessionTable } from "@smart-ai/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@smart-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".smart", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@smart/Session") {}
