...
import { AbsolutePath, type DeepMutable } from "@smart-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@smart/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".smart", "plans", "*.md")]: "allow",
