...
const releaseId = process.env.SMART_RELEASE
if (!releaseId) throw new Error("SMART_RELEASE is required")

const version = process.env.SMART_VERSION
if (!version) throw new Error("SMART_VERSION is required")
