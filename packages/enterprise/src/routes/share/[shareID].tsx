import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@smartcode-ai/sdk/v2"
import { SessionTurn } from "@smartcode-ai/ui/session-turn"
import { SessionReview } from "@smartcode-ai/ui/session-review"
import { DataProvider } from "@smartcode-ai/ui/context"
import { FileComponentProvider } from "@smartcode-ai/ui/context/file"
import { WorkerPoolProvider } from "@smartcode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@smartcode-ai/ui/logo"
import { IconButton } from "@smartcode-ai/ui/icon-button"
import { ProviderIcon } from "@smartcode-ai/ui/provider-icon"
...
import { Tabs } from "@smartcode-ai/ui/tabs"
import { MessageNav } from "@smartcode-ai/ui/message-nav"
import { FileSSR } from "@smartcode-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@smartcode-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/smart-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Smart</Title>
              </Show>
              <Meta name="description" content="smart - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/smart"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
