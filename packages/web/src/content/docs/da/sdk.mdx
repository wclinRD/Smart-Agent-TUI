...
Brug den til at bygge integrasjoner og kontrollere smart programmatisk.
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `smart.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av smart, kan du oprete en klientforekomst for at koble til den:
