---
title: LSP-servere
description: Smart integreres med dine LSP-servere.
---

Smart kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Smart leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `SMART_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og smart åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din smart-konfiguration.
