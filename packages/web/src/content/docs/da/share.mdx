---
title: Deling
description: Del dine Smart-samtaler.
---

Smarts delingsfunksjon lar deg lage offentlige lenker til dine Smart-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Smart støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger Smart manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `smart.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av smart i organisasjonen din.
