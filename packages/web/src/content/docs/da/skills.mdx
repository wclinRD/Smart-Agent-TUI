...
Agentferdigheter lar Smart oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Smart søker etter disse stedene:

- Prosjektkonfigurasjon: `.smart/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/smart/skills/<name>/SKILL.md`
...
For prosjektlokale stier går Smart opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.smart/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/smart/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.smart/skills/git-release/SKILL.md` slik:
...
Smart viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `smart.json`:
...
**For innebygde agenter** (i `smart.json`):
