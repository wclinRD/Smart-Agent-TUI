...
Her er alle de innebygde verktøyene som er tilgængelige i Smart.
...
:::note
Dette verktøyet er bare tilgængelig når `SMART_EXPERIMENTAL_LSP_TOOL=true` (eller `SMART_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Smart-leverandøren eller når miljøvariabelen `SMART_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
