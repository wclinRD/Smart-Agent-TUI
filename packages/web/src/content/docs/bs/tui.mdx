---
title: TUI
description: Korištenje korisničkog interfejsa Smart terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Smart pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Smart pokreće TUI za trenutni direktorij.
...
Kada koristite Smart TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Smart. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Smart. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `smart.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Smart čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `smart.default`.
