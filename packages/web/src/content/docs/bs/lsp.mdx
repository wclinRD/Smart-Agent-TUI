---
title: LSP serveri
description: Smart se integriše sa vašim LSP serverima.
---

Smart se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Smart dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `SMART_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i smart otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj smart konfiguraciji.
