...
Kreiraj `.smart/commands/test.md`:
...
Možete dodati prilagođene komande kroz Smart konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Smart [config](/docs/config):
...
- Globalno: `~/.config/smart/commands/`
- Po projektu: `.smart/commands/`
...
Smart uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
