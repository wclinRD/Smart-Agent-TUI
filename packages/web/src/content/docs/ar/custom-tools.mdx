...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في smart.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في smart مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.smart/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/smart/tools/`.
