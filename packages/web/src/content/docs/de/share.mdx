---
title: Teilen
description: Teile Smart-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Smart-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Smart Folgendes:
...
Smart hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Smart den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`smart.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du smart in deiner Organisation einsetzt.
