...
Erstellen Sie `.smart/commands/test.md`:

```md title=".smart/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Smart-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Smart [config](/docs/config):

```json title="smart.jsonc" {4-12}
{
...
- Global: `~/.config/smart/commands/`
- Pro Projekt: `.smart/commands/`

```markdown title="~/.config/smart/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".smart/commands/component.md"
---
...
```md title=".smart/commands/create-file.md"
---
...
```md title=".smart/commands/analyze-coverage.md"
---
...
```md title=".smart/commands/review-changes.md"
---
...
```md title=".smart/commands/review-component.md"
---
...
Smart enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
