...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Smart:
...
- ระดับผู้ใช้ (Global): `~/.config/smart/commands/`
- ระดับโปรเจ็กต์: `.smart/commands/`
...
Smart มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
