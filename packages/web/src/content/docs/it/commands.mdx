...
Puoi aggiungere comandi personalizzati tramite la config di Smart o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Smart:
...
- Globale: `~/.config/smart/commands/`
- Per progetto: `.smart/commands/`
...
smart include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
