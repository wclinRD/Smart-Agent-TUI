...
You can add custom commands through the Smart config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Smart [config](/docs/config):
...
smart includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
