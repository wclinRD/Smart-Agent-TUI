...
Puede agregar comandos personalizados a través de la configuración Smart o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Smart [config](/docs/config):
...
smart incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
