...
Możesz zdefiniować polecenia w `smart.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji smart:
...
- Globalnie: `~/.config/smart/commands/`
- Na projekt: `.smart/commands/`
...
smart zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
