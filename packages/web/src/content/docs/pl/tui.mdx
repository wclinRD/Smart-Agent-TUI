---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala smart.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

smart zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie smart uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI smart, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do smart. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `smart.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Smart czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `smart.default`.
