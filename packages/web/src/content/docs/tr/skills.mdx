...
Ajan becerileri, smart'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
smart su konumlari tarar:

- Proje konfigurasyonu: `.smart/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/smart/skills/<name>/SKILL.md`
...
Proje yerel yollarinda smart, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.smart/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/smart/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.smart/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
smart, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`smart.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`smart.json` icinde):
