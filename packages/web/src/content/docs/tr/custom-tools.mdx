---
title: Özel Araçlar
description: LLM'un smart'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. smart'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.smart/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/smart/tools/` içine yerleştirerek.
