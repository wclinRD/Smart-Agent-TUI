---
title: Zen
description: smart tarafından sağlanan seçilmiş modeller listesi.
---
...
Smart Zen, Smart ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Smart'daki diğer sağlayıcılar gibi çalışır. Smart Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Smart kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Smart ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Smart Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Smart Zen, Smart'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Smart Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Smart Zen'i seçin ve API anahtarınızı yapıştırın.
...
Smart yapılandırmanızdaki [model id](/docs/config/#models) `smart/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `smart/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Smart'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Smart'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için Smart'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Smart'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Smart'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Smart Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Smart ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
