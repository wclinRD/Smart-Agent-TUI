...
description: smart dile özgü biçimlendiriciler kullanır.
---

smart, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

smart, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, smart bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

smart bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri smart yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
