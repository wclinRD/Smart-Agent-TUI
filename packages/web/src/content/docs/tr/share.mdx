---
title: Paylasim
description: smart konusmalarini genel baglantilarla paylasin.
---

smart'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda smart:
...
smart, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak smart manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `smart.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda smart kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
