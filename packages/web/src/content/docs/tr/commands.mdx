...
`.smart/commands/test.md` oluştur:
...
smart işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

smart [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/smart/commands/`
- Proje başına: `.smart/commands/`
...
smart, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
