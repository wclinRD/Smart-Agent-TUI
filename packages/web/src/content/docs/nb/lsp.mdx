---
title: LSP-servere
description: smart integreres med LSP-serverne dine.
---

Smart kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Smart kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `SMART_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og smart åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Smart-konfigurasjonen.
