...
Agentferdigheter lar Smart oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går smart opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
smart viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `smart.json`:
