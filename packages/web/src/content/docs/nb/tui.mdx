---
title: TUI
description: Bruke smart-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Smart gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Smart starter TUI for gjeldende katalog.
...
Når du bruker Smart TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Smart. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Smart. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `smart.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Smart venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `smart.default`.
