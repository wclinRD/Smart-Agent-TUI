...
class Database extends Context.Service<Database, DatabaseShape>()("@smart/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@smart/example/UserStore") {
