...
class Database extends Context.Service<Database, DatabaseShape>()("@smartcode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@smartcode/example/UserStore") {
