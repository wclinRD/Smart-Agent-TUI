import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@smartcode-ai/sdk/v2/client"
...
import { List, type ListRef } from "@smartcode-ai/ui/list"
        ...
        <Switch>
          <Match when={provider().id === "smartcode"}>
            <div class="flex flex-col gap-4">
              ...
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.smartZen.visit.prefix")}
                <Link href="https://smart.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.smartZen.visit.link")}
                </Link>
                {language.t("provider.connect.smartZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
