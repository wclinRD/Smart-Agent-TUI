...
export const dict = {
  ...
  "dialog.provider.smart.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.smart.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.smartGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Smart tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Smart'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.smartZen.line1":
    "Smart Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.smartZen.visit.prefix": "",
  "provider.connect.smartZen.visit.link": "smart.ai/zen",
  "provider.connect.smartZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Smart'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Smart'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler smartcode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Smart sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Smart'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Smart ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (smartcode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Smart henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Smart ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Smart Masaüstü",
  ...
  "settings.desktop.wsl.description": "Smart sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Smart'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Smart'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Smart'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Smart'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Smart başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Smart'un en son sürümünü kullanıyorsunuz.",
