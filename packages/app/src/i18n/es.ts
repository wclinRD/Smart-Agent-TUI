export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurados en smart.json",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (smart.json)",
