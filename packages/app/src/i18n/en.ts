export const dict = {
  ...
  "dialog.provider.smart.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.smart.tagline": "Reliable optimized models",
  "dialog.provider.smartGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Smart",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Smart.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.smartZen.line1":
    "Smart Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.smartZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.smartZen.visit.prefix": "Visit ",
  "provider.connect.smartZen.visit.link": "smart.ai/zen",
  "provider.connect.smartZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Smart.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Smart.",
  ...
  "dialog.plugins.empty": "Plugins configured in smartcode.json",
  ...
  "dialog.server.description": "Switch which Smart server this app connects to.",
  ...
  "wsl.onboarding.step.smart": "Smart",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Smart...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Smart in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Smart...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Smart in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Smart in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Smart",
  "wsl.onboarding.smartReadyIn": "Smart is ready in {{distro}}.",
  "wsl.onboarding.smartReady": "Smart is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Smart in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Smart",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Smart.",
  ...
  "toast.update.description": "A new version of Smart ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Smart team",
  ...
  "error.chain.checkConfig": "Check your config (smartcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Smart does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Smart includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Smart Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Smart server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Smart",
  ...
  "settings.general.row.appearance.description": "Customise how Smart looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Smart follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Smart is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Smart launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Smart.",
