export const dict = {
  ...
  "dialog.provider.smart.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.smart.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.smartGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Smart",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Smart.",
  ...
  "provider.connect.smartZen.line1":
    "Smart Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.smartZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.smartZen.visit.prefix": "Visite ",
  "provider.connect.smartZen.visit.link": "smart.ai/zen",
  "provider.connect.smartZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Smart.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Smart.",
  ...
  "dialog.plugins.empty": "Plugins configurados em smartcode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Smart este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Smart ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Smart",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (smartcode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Smart ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Smart inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Smart dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Smart",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Smart aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Smart segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Smart é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Smart iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Smart.",
