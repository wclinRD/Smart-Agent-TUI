export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurés dans smart.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (smart.json) pour les noms de fournisseur/modèle",
