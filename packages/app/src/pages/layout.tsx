...
import { ResizeHandle } from "@smartcode-ai/ui/resize-handle"
...
import { Session, type Message } from "@smartcode-ai/sdk/v2/client"
...
import { toaster } from "@smartcode-ai/ui/toast"
...
import { useTheme, type ColorScheme } from "@smartcode-ai/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://smart.ai/desktop-feedback")}
      renderPanel={() =>
