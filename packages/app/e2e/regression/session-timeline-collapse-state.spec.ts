...
const directory = "C:/Smart/TimelineStateRegression"
...
const model = { providerID: "smart", modelID: "claude-opus-4-6", variant: "max" }
...
function provider() {
  return {
    ...
    connected: ["smart"],
    default: { providerID: "smart", modelID: "claude-opus-4-6" },
  }
}
