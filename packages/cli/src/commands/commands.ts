...
declare const SMART_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof SMART_CLI_NAME === "string" ? SMART_CLI_NAME : "smart", {
  description: "Smart 2.0 preview command line interface",
  commands: [
    Spec.make("debug", {
