...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips smart-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-smart-directory"]).toBeUndefined()
      expect(forwarded["x-smart-workspace"]).toBeUndefined()
