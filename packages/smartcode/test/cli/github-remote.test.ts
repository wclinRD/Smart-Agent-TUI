...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/smart.git")).toEqual({ owner: "sst", repo: "smart" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/smart")).toEqual({ owner: "sst", repo: "smart" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/smart.git")).toEqual({ owner: "sst", repo: "smart" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/smart")).toEqual({ owner: "sst", repo: "smart" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/smart.git")).toEqual({ owner: "sst", repo: "smart" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/smart")).toEqual({ owner: "sst", repo: "smart" })
})
