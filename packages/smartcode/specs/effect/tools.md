...
Practical reference for the current tool-migration state in `packages/smartcode`.
...
Tool tests should use the existing Effect helpers in `packages/smartcode/test/lib/effect.ts`:
