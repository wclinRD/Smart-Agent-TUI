...
import { AccountStateTable, AccountTable } from "@smartcode-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@smartcode/AccountRepo") {}
