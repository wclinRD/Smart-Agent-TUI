...
import { ProjectDirectoryTable, ProjectTable } from "@smartcode-ai/core/project/sql"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@smartcode-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@smartcode/Project") {}
