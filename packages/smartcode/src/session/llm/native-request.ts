import type { JsonSchema, LLMRequest, ProviderMetadata } from "@smartcode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@smartcode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @smartcode-ai/llm request objects from smart's session/AI SDK-shaped data.
  return LLM.request({
