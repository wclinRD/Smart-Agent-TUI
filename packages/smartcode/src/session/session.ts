...
import { Slug } from "@smartcode-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@smartcode-ai/llm"
...
import { PartTable, SessionTable } from "@smartcode-ai/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@smartcode-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".smartcode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@smartcode/Session") {}
