...
import { buildPrompt } from "@smartcode-ai/core/session/compaction"
...
export class Service extends Context.Service<Service, Interface>()("@smartcode/SessionCompaction") {}
