 ...
 *   "@smartcode/ServerAuthConfig",
 *   {
 *     password: Config.string("SMART_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("SMART_SERVER_USERNAME").pipe(Config.withDefault("smart")),
 *   },
 * ) {}
 *
