...
import { errorData, errorMessage } from "@smartcode-ai/tui/util/error"
...
import { hasTheme, upsertTheme } from "@smartcode-ai/tui/context/theme"
...
import type { HostPluginApi, HostSlots } from "@smartcode-ai/tui/plugin/slots"
import { ConfigPlugin } from "@/config/plugin"
import { ConfigPluginV1 } from "@smartcode-ai/core/v1/config/plugin"
import { createCommandShim } from "@smartcode-ai/tui/plugin/command-shim"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Effect } from "effect"
import { createPluginRuntime, type PluginRuntime, type TuiPluginHost } from "@smartcode-ai/tui/plugin/runtime"
...
async function load(input: {
  ...
  try {
    ...
    const records = Flag.SMART_PURE ? [] : pluginOrigins
    if (Flag.SMART_PURE && pluginOrigins.length) {
    }
