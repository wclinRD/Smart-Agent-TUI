...
import { ConfigMCPV1 } from "@smartcode-ai/core/v1/config/mcp"
...
function createClient(directory: string) {
  const client = new Client({ name: "smartcode", version: InstallationVersion }, CLIENT_OPTIONS)
...
export class Service extends Context.Service<Service, Interface>()("@smartcode/MCP") {}
