...
import { path } from "@smartcode-ai/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@smartcode-ai/core/project"
...
export class Service extends Context.Service<Service, Interface>()("@smartcode/Worktree") {}
