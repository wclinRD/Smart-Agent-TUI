...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@smartcode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@smartcode/ACPDirectory") {}
