...
import type { AssistantMessage as SmartAssistantMessage, Message } from "@smartcode-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<SmartAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<SmartAssistantMessage, "role"> &
  Partial<Pick<SmartAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@smartcode/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@smartcode/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@smartcode/ACPUsage") {}
