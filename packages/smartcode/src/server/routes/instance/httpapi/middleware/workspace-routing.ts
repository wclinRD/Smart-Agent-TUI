...
>()("@smartcode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@smartcode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.SMART_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.SMART_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-smart-directory"] || process.cwd()
}
