...
//
// The saved variant persists across sessions in ~/.local/state/smart/model.json
...
class Service extends Context.Service<Service, VariantService>()("@smartcode/RunVariant") {}
