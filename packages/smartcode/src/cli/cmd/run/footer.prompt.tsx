...
import { normalizePromptContent } from "@smartcode-ai/tui/editor"
...
import { SMART_BASE_MODE, useBindings } from "@smartcode-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Smart" } satisfies SlashOption,
    ]
