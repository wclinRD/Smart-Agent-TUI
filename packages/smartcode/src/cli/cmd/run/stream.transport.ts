...
import type { Event, GlobalEvent, OpencodeClient } from "@smartcode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@smartcode/RunStreamTransport") {}
