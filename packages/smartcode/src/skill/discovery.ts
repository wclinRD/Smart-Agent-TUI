...
import { httpClient, path } from "@smartcode-ai/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@smartcode/SkillDiscovery") {}
