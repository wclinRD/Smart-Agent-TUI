...
import type * as SDK from "@smartcode-ai/sdk/v2"
...
import { SessionShareTable } from "@smartcode-ai/core/share/sql"
...
export class Service extends Context.Service<Service, Interface>()("@smartcode/ShareNext") {}
