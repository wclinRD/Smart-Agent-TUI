...
import { optionalOmitUndefined } from "@smartcode-ai/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@smartcode-ai/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
      ...
      if (!apiToken) {
        throw new Error(
          "CLOUDFLARE_API_TOKEN (or CF_AIG_TOKEN) is required for Cloudflare AI Gateway. " +
            "Set it via environment variable or run `smartcode auth cloudflare-ai-gateway`.",
        )
      }
...
export class Service extends Context.Service<Service, Interface>()("@smartcode/Provider") {}
