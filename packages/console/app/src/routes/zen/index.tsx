...
import compareVideo from "../../asset/lander/smart-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/smart-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="smart:auth" content={loggedin() ? "true" : "false"} />
