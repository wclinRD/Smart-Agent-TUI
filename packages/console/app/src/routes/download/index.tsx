...
import desktopAppIcon from "../../asset/lander/smart-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://smart.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>smart.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g smart-ai")}>
                <code>
                  npm i -g <strong>smart-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g smart-ai")}>
                <code>
                  bun add -g <strong>smart-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/smart")}>
                <code>
                  brew install <strong>anomalyco/tap/smart</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S smart")}>
                <code>
                  paru -S <strong>smart</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask smart-desktop")}>
                <code>
                  brew install --cask <strong>smart-desktop</strong>
                </code>
                <CopyStatus />
              </button>
