...
import { getOpencodeModeStack, SMART_BASE_MODE, OpencodeKeymapProvider, registerOpencodeKeymap } from "../src/keymap"
...
test("mode-less bindings stay active when smart mode changes", async () => {
