...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/smart/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/smart...\n")
...
console.log("Fetching npm all-time downloads for smart-ai...\n")
const npmDownloads = await fetchNpmDownloads("smart-ai")
