...
Generates UPCOMING_CHANGELOG.md by running the smart changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for smart run (default: low)
      --quiet            Suppress smart command output unless it fails
