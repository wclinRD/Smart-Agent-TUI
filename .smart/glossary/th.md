...
- PR #10809: https://github.com/anomalyco/smart/pull/10809
- PR #11496: https://github.com/anomalyco/smart/pull/11496

## Do Not Translate (Locale Additions)

- `Smart` (preserve casing in prose; keep `smart` only in commands, package names, paths, or code)
- `Smart CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
