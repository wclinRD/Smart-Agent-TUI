...
Use this folder for locale-specific translation guidance that supplements `.smart/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/smart/pull/12345

## Do Not Translate (Locale Additions)

- `Smart` (preserve casing)
