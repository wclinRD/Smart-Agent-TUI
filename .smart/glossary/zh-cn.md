...
- PR #13942: https://github.com/anomalyco/smart/pull/13942

## Do Not Translate (Locale Additions)

- `Smart` (preserve casing in prose; keep `smart` only when it is part of commands, package names, paths, or code)
- `Smart Zen`
- `Smart CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `smart` in prose when referring to the product name; use `Smart`
