...
- PR #15835: https://github.com/anomalyco/smart/pull/15835

## Do Not Translate (Locale Additions)

- `Smart` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `smart` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Smart` in prose, `smart` only for exact technical identifiers
...
- Avoid changing `smart` to `Smart` inside commands, URLs, package names, or code literals
